...
<body>
	...
	<div class="container">
		<!-- Submits to search_results.php using GET -->
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<select name="genre" id="genre-id" class="form-control">
						...
						<?php
						// Loop through results1 and generate options
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<select name="rating" id="rating-id" class="form-control">
						...
						<?php
							// Loop through results2 and generate options
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<select name="label" id="label-id" class="form-control">
						...
						<?php
							// Loop through results3 and generate options
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<select name="format" id="format-id" class="form-control">
						...
						<?php
							// Loop through results4 and generate options
			...
			<div class="form-group row">
				...
				<div class="col-sm-9">
					<select name="sound" id="sound-id" class="form-control">
						...
						<?php
							// Loop through results5 and generate options
